    ...
    <section className=" w-full font-bold text-6xl max-md:text-3xl relative flex flex-col  items-center  gap-5">
      ...
      <div className="absolute top-[10%] flex w-[50%] flex-col items-center justify-center max-md:w-[80%] gap-5">
        ...
        <h1 className="text-center w-[90%]">
          ...
          <span className="text-[#2aaae0]">3-Day</span> Credential Evaluations,
          Flat Rate Guarantee!
        </h1>
        <div className="flex gap-3">
          <Button className="bg-[#2aaae0] font-bold rounded-full p-6">
            Start Evaluation
          </Button>
          <Button
            variant={"outline"}
            className="border-[#2aaae0] bg-transparent font-bold rounded-full p-6"
          >
            Read Reviews
          </Button>
        </div>
